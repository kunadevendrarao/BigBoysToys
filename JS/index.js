...
function logintowebpage()
{
    ...
    if(userId==userGivenID && pass==userGivenPass)
    {
        ...
        fom[0].action="./js/Carproject1.html"
...
function passvis()
{
    ...
    document.getElementById("visible").setAttribute("src","./Asset/Logs/visible.png")
...
function passhide()
{
    ...
    document.getElementById("visible").setAttribute("src","./Asset/Logs/notvisible.jpg")
    document.getElementById("visible").style.transform="rotateY(-360deg)"
    document.getElementById("visible").style.transition="transform 0.3s"
}